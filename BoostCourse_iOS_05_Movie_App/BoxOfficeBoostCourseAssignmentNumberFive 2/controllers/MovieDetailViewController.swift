    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0:
            ...
            DispatchQueue.global().async {
                guard let imageAddress:String = detail.imageAddress
                else {
                    print("can't get detail.imageAddress")
                    return
                    
                }
                guard let imageURL: URL = URL(string: imageAddress)
                    else {return}
